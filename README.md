...
`go-pict` is a Go utility package for parsing and processing test cases generated by PICT (Pairwise Independent Combinatorial Testing).

## Features

- **Easy Parsing**: Parse PICT output with a simple API
